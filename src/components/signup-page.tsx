...
//   SelectValue,
// } from "@/components/ui/select";
// import { Eye, EyeOff, Loader2, ArrowLeft, Mail, User } from "lucide-react";
// import { useMutation } from "@tanstack/react-query";
// import { toast } from "react-toastify";
...
//     mutate({ email, password, firstName, gender, confirmPassword });
...
//             {currentStep === 1 ? "Email" : "Complete Profile"}
//           </CardTitle>
//           <CardDescription className="text-gray-600">
//             {currentStep === 1 ? "" : "Fill in your details to continue"}
//           </CardDescription>
//         </CardHeader>
//         <CardContent>
//           {currentStep === 1 ? (
...
//             <Button
//               variant="link"
//               className="p-0 h-auto text-black hover:underline"
//               onClick={() => router.push("/login")}
//             >
//               Sign in
//             </Button>
